...
<p>We carry the common gears, boards, sensors, and remotes for LiftMaster, Chamberlain, Genie, Marantec and Craftsman, so most repairs are one visit.</p>` },
  ...
  },
  {
    ...
    metaDesc: "New garage door opener supply & install across Greater Vancouver from $439. LiftMaster belt, chain & wall-mount with myQ smart control. Full warranty.",
...
<p>If a cable has already let go, the door is now unbalanced and the springs are doing uneven work. Don't run it — call us and leave it down until we re-tension both sides.</p>` },
  ...
  },
  {
    ...
    metaDesc: "New garage door supply & installation across Greater Vancouver from $1,690. Insulated steel, modern aluminium-glass & carriage styles. Free measure & written quote.",
    ...
    serviceType: "New Garage Door Installation", priceFrom: 1690,
    answer: `<p><strong>A new garage door supplied and installed in Greater Vancouver typically starts around $1,690 and ranges higher for insulated, glass, or custom carriage styles.</strong> We do a free on-site measure, give you a fixed written quote, remove and recycle the old door, and install a properly insulated, weather-sealed door built for coastal wet and wind. No vague "starting from" that triples on install day.</p>`,
    sections: [
    ...
    faqs: [
      { q: "How much does a new garage door cost installed in Vancouver?", a: "From about $1,690 for a standard insulated single door installed, more for double doors, glass, or carriage styles. You get a fixed written quote after a free measure — no install-day surprises." },
