...
export const SERVICES = [
  {
    ...
    metaDesc: "Same-day broken garage door spring repair across Greater Vancouver. Honest flat pricing, free cables on 2-spring jobs, free safety inspection. Licensed, insured, WorkSafeBC.",
...
<p><strong>High-cycle springs</strong> are rated for roughly 20,000–30,000 open/close cycles instead of the standard ~10,000. For a busy family door that's the difference between ~7 years and 15+ years. They cost more up front; for some homes they're worth it and for others they aren't. We'll tell you which you are.</p>` },
  ...
  },
  {
    ...
    metaDesc: "Garage door opener not working? Same-day opener repair across Metro Vancouver — LiftMaster, Chamberlain, Genie & more. Honest pricing, fixed right or we come back free.",
...
<p>We carry the common gears, boards, sensors, and remotes for LiftMaster, Chamberlain, Genie, Marantec and Craftsman, so most repairs are one visit.</p>` },
  ...
  },
  {
    ...
    metaDesc: "New garage door opener supply & installation across Greater Vancouver. LiftMaster belt, chain & wall-mount with myQ smart control. Honest pricing, tidy install, full warranty.",
    ...
    serviceType: "Garage Door Opener Installation", priceFrom: 439,
    answer: `<p><strong>A new LiftMaster opener supplied and professionally installed in Greater Vancouver typically runs from $439, including haul-away of the old unit.</strong> We fit belt-drive (quietest — ideal under a bedroom), chain-drive (toughest value), and wall-mount jackshaft openers, all with myQ smart-phone control and battery backup options so the door still works in a Lower Mainland power outage.</p>`,
    sections: [
    ...
    faqs: [
      { q: "How much does it cost to install a new garage door opener?", a: "From $439 supplied and installed, including programming and removal of your old opener. Belt-drive and wall-mount units sit higher than basic chain-drive." },
...
<p>If a cable has already let go, the door is now unbalanced and the springs are doing uneven work. Don't run it — call us and leave it down until we re-tension both sides.</p>` },
  ...
  },
  {
    ...
    metaDesc: "Garage door off its track or jammed crooked? Same-day off-track repair across Metro Vancouver from $169. Don't force it — we'll reset rollers, straighten track & re-balance.",
  ...
  },
  {
    ...
    metaDesc: "Noisy, grinding, or wobbly garage door? Roller replacement across Metro Vancouver from $129. Quiet nylon rollers fitted same-day. Licensed, insured, WorkSafeBC-covered.",
  ...
  },
  {
    ...
    metaDesc: "New garage door supply & installation across Greater Vancouver from $1,290. Insulated steel, modern aluminium-glass & carriage styles. Free measure & written quote.",
    ...
    serviceType: "New Garage Door Installation", priceFrom: 1290,
    answer: `<p><strong>A new garage door supplied and installed in Greater Vancouver typically starts around $1,290 and ranges higher for insulated, glass, or custom carriage styles.</strong> We do a free on-site measure, give you a fixed written quote, remove and recycle the old door, and install a properly insulated, weather-sealed door built for coastal wet and wind. No vague "starting from" that triples on install day.</p>`,
    sections: [
    ...
    faqs: [
      { q: "How much does a new garage door cost installed in Vancouver?", a: "From about $1,290 for a standard insulated single door installed, more for double doors, glass, or carriage styles. You get a fixed written quote after a free measure — no install-day surprises." },
  ...
  },
  {
    ...
    seoTitle: "Garage Door Maintenance & Tune-Up Greater Vancouver | Probably Fine",
...
<p>Those steep Burnaby driveways are hard on doors, too: a door that's even slightly out of balance shows it fast on a slope. We re-balance properly rather than just cranking spring tension, so the opener isn't fighting the door every cycle.</p>`,
  ...
  },
  {
    ...
    metaDesc: "Same-day garage door repair in Surrey — springs, openers, double doors & new installs. Cloverdale to South Surrey. Honest flat pricing, licensed, insured, WorkSafeBC.",
...
<p>Out in <strong>Cloverdale and the acreages toward Campbell Heights</strong>, we see larger and detached shop doors that take a beating from rural use. And the older stock around <strong>Whalley and Newton</strong> often needs the full refresh — springs, rollers and cables together. Wherever you are in Surrey, you get the same flat, written price.</p>`,
  ...
  },
  {
    ...
    metaDesc: "Same-day garage door repair in Richmond — springs, openers, cables & new doors. Steveston to Brighouse. Salt-air corrosion specialists. Honest pricing, licensed & insured.",
...
<p>The housing varies from older cottages and ranchers around <strong>Steveston and Sea Island</strong> to the newer executive homes of <strong>Terra Nova, Westwind and Riverdale</strong> with big insulated doubles. Whatever the door, the corrosion question is the same one — and it's the one we check first.</p>`,
  ...
  },
  {
    ...
    metaDesc: "Same-day garage door repair in Coquitlam & the Tri-Cities — springs, openers, cables & new doors. Burke Mountain to Maillardville. Cold-snap spring specialists, licensed & insured.",
