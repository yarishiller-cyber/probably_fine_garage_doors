...
<p>If a cable has already let go, the door is now unbalanced and the springs are doing uneven work. Don't run it — call us and leave it down until we re-tension both sides.</p>` },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: "Why it went off-track (so it stays on)", html: `<p>A door rarely jumps the track for no reason. Usual causes: a <a href="/garage-door-cable-repair/">snapped cable</a> that let one side drop, <a href="/garage-door-roller-repair/">worn rollers</a> that wobbled out, a loosened track bracket, or a love-tap from a bumper. We fix the symptom <em>and</em> the cause — otherwise you'll see us again next month, which we'd both rather avoid.</p>` },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: "What a fair quote includes", html: `<p>Our written quote covers the door, tracks, springs sized to the new weight, weather seals, removal and recycling of the old door, and the labour. If you want an opener fitted at the same time, see <a href="/garage-door-opener-installation/">opener installation</a> — bundling saves a second trip.</p>` },
    ],
    faqs: [
  ...
  },
  {
    ...
    metaDesc: "Annual garage door tune-up across Metro Vancouver from $109 — 25-point balance, lubricate, tighten & safety-check to prevent breakdowns. Book before winter.",
...
export const CITIES = [
  {
    ...
    metaDesc: "Same-day garage door repair in Vancouver, BC — springs, openers, cables & off-track, East Van to the West Side. Honest pricing, licensed & insured.",
...
<p>The common thread is weather. Vancouver's wet, salty air is brutal on torsion springs and lift cables — we see more corrosion-driven failures here than anywhere drier. We fit galvanized springs and sealed nylon rollers as standard, because the coast eats the cheap stuff.</p>`,
  ...
  },
  {
    ...
    metaDesc: "Same-day garage door repair in Burnaby — springs, openers, cables & off-track, Metrotown to Burnaby Mountain. Honest flat pricing, licensed & insured.",
